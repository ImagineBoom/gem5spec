...
# smt se.py
#CACHE_OPT += --ruby --mem-size=16384MB --caches --l1d_size=64kB --l1d_assoc=8 --l1i_size=32kB --l1i_assoc=8 --l2cache --l2_size=512kB --l2_assoc=8 --l3_size=8MB --l3_assoc=8 --cacheline_size=64 --network=garnet --topology=CrossbarGarnet --l2_hit_latency=3
#CACHE_OPT += --ruby --mem-size=16384MB --caches --l1d_size=32kB --l1d_assoc=8 --l1i_size=16kB --l1i_assoc=8 --l2cache --l2_size=512kB --l2_assoc=8 --l3_size=8MB --l3_assoc=8 --cacheline_size=64 --network=garnet --topology=CrossbarGarnet --l2_hit_latency=3
#CACHE_OPT += --ruby --mem-size=16384MB --caches --l1d_size=16kB --l1d_assoc=8 --l1i_size=8kB --l1i_assoc=8 --l2cache --l2_size=512kB --l2_assoc=8 --l3_size=8MB --l3_assoc=8 --cacheline_size=64 --network=garnet --topology=CrossbarGarnet --l2_hit_latency=3
#CACHE_OPT += --ruby --mem-size=16384MB --caches --l1d_size=8kB --l1d_assoc=8 --l1i_size=4kB --l1i_assoc=8 --l2cache --l2_size=512kB --l2_assoc=8 --l3_size=8MB --l3_assoc=8 --cacheline_size=64 --network=garnet --topology=CrossbarGarnet --l2_hit_latency=3
